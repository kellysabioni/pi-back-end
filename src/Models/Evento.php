...
class Evento {
    ...
    public function __construct(string $nome, string $descricao, string $data, string $hora, string $CEP, string $rua, string $numero, string $bairro, string $cidade, string $UF, string $telefone, Categoria $categoria = Categoria::Indefinido, ?int $projetos_id = null, string $created_at, string $updated_at,  ?int $usuarios_id = null, ?int $id = null)
    {
        $this->setId($id);
        $this->setNome($nome);
    ...
    public function getUsuarios_id(): ?int {return $this->usuarios_id;}
    public function getProjetos_id(): ?int {return $this->projetos_id;}
    ...
    private function setUsuarios_id(?int $usuarios_id): void {$this->usuarios_id = $usuarios_id;}
    private function setProjetos_id(?int $projetos_id): void {$this->projetos_id = $projetos_id;}
}